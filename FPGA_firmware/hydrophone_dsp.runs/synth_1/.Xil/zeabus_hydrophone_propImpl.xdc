set_property SRC_FILE_INFO {cfile:{C:/OneDrive/OneDrive - KASETSART UNIVERSITY/akp/AUV/zeabus_hydrophone/FPGA_firmware/zeabus_hydrophone.xdc} rfile:../../../zeabus_hydrophone.xdc id:1} [current_design]
