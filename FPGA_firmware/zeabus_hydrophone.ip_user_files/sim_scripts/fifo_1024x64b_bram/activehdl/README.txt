...
#
# Generated by export_simulation on Sat Dec 28 17:41:59 +0700 2019
#
################################################################################
...
'-reset_run' switch to the './fifo_1024x64b_bram.sh' script.

./fifo_1024x64b_bram.sh -reset_run
...
./fifo_1024x64b_bram.sh -noclean_files

For more information on the script, please type './fifo_1024x64b_bram.sh -help'.
