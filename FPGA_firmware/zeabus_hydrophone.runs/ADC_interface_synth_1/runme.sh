...
HD_PWD='C:/Users/akrap/Google/AUV/zeabus_hydrophone/FPGA_firmware/zeabus_hydrophone.runs/ADC_interface_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_interface.tcl
