...
HD_PWD='C:/Users/akrap/Google/AUV/zeabus_hydrophone/FPGA_firmware/zeabus_hydrophone.runs/gain0_005_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gain0_005_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gain0_005_mult.tcl
