...
int abs_threshold_CFAR(uint32_t index) {
	...
	signal_temp[0] = (float32_t)(g_adc1_2_buffer[index]  - 32768) / 65535;
	signal_temp[1] = (float32_t)(g_adc1_2_buffer[index + 1]  - 32768) / 65535;
	signal_temp[2] = (float32_t)(g_adc3_4_buffer[index]  - 32768) / 65535;
	signal_temp[3] = (float32_t)(g_adc3_4_buffer[index + 1]  - 32768) / 65535;
