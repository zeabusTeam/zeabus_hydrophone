...
HD_PWD='C:/Users/akrap/Google/AUV/zeabus_hydrophone/SlaveFIFO_verify/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_verify.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo_verify.tcl -notrace
