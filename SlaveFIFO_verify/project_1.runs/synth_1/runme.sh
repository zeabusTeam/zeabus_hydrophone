...
HD_PWD='C:/Users/akrap/Google/AUV/zeabus_hydrophone/SlaveFIFO_verify/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_verify.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_verify.tcl
