...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_zeabus_hydrophone_concrete_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_zeabus_hydrophone_concrete_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_zeabus_hydrophone_concrete_third_party_uses_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "zeabus_hydrophone_concrete") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_zeabus_hydrophone_concrete_third_party_uses_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_zeabus_hydrophone_concrete_jit_fallback_info( int nlhs,
  ...
  if (strcmp(machineName, "zeabus_hydrophone_concrete") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_zeabus_hydrophone_concrete_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_post_codegen_info_call( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_zeabus_hydrophone_concrete_get_post_codegen_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "zeabus_hydrophone_concrete") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_zeabus_hydrophone_concrete_get_post_codegen_info(nlhs,plhs,3,
      newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_zeabus_hydrophone_concrete_updateBuildInfo_args_info
  ...
  if (strcmp(machineName, "zeabus_hydrophone_concrete") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_zeabus_hydrophone_concrete_updateBuildInfo_args_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_zeabus_hydrophone_concrete_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "zeabus_hydrophone_concrete") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_zeabus_hydrophone_concrete_get_eml_resolved_functions_info(nlhs,
      plhs,3,newRhs);
  }
...
extern unsigned int sf_zeabus_hydrophone_concrete_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"zeabus_hydrophone_concrete")) {
    return(sf_zeabus_hydrophone_concrete_method_dispatcher(simstructPtr,
...
extern void zeabus_hydrophone_concrete_terminator(void);
void sf_machine_global_terminator(SimStruct* S)
{
  (void)S;
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    zeabus_hydrophone_concrete_terminator();
  }

  return;
}

extern void zeabus_hydrophone_concrete_initializer(void);
extern void zeabus_hydrophone_concrete_register_exported_symbols(SimStruct* S);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  zeabus_hydrophone_concrete_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    zeabus_hydrophone_concrete_initializer();
  }
